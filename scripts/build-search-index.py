...
DB_SLUGS = {
    ...
    # Weibang — modelli REALI del catalogo Weibang Italia (verificati 2026-05-27)
    ("weibang", "wb 506 sc"):     "weibang-wb-506-sc",
    ("weibang", "wb 506 sc3"):    "weibang-wb-506-sc3",
    ("weibang", "wb 537 sc3"):    "weibang-wb-537-sc3",
    ("weibang", "wb 456 scve3"):  "weibang-wb-456-scve3",
    ("weibang", "wb 466 scm"):    "weibang-wb-466-scm",
    ("weibang", "wb 537 scval"):  "weibang-wb-537-scval",
    ("weibang", "wb 537 scvalb"): "weibang-wb-537-scvalb",
    ("weibang", "wb 537 scvm"):   "weibang-wb-537-scvm",
    ("weibang", "wb 778 scv3"):   "weibang-wb-778-scv3",
    ("weibang", "wb 452 he"):     "weibang-wb-452-he",
    ("weibang", "wb 462 sem"):    "weibang-wb-462-sem",
}
